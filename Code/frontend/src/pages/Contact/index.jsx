          ...
          <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-2xl p-8">
            ...
            <form className="space-y-6">
              ...
              <div>
                ...
                <select className="w-full px-4 py-3 bg-gray-700/50 border border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-white">
              ...
              <button
                type="submit"
                className="w-full bg-blue-600 hover:bg-blue-500 px-8 py-4 rounded-lg font-medium transition-colors"
              >
                Enviar mensagem
              </button>
            </form>
