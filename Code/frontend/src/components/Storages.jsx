        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
          <div>
            ...
            <p className="text-slate-400 mt-1">
              Organize e controle seus estoques de forma eficiente
            </p>
          </div>
          <button
        ...
        {loading ? (
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-2xl p-12 text-center">
            ...
            <p className="text-slate-400 mb-6">
              Comece criando seu primeiro estoque para organizar seus itens
            </p>
            <button
                ...
                <div className="bg-gradient-to-r from-slate-800/50 to-slate-900/50 p-6 border-b border-slate-800">
                  <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                    <div className="flex-1">
                      ...
                      <span
                        className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-lg text-xs font-semibold ${getAccessLevelColor(
                          s.accessLevel
                        )}`}
                      >
                        <svg
                    ...
                    <div className="flex flex-wrap gap-2">
                      ...
                      {!["guest", "co-owner", "coowner"].includes(
                        String(s.accessLevel || "").toLowerCase()
                      ) && (
                              <button
                                onClick={() => {
                      ...
                      {String(s.accessLevel || "").toLowerCase() !== "guest" && (
                        <button
                          onClick={() =>
                            setActiveStorageId(
                              activeStorageId === s.id ? null : s.id
                            )
                         }
